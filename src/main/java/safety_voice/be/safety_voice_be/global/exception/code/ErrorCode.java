package safety_voice.be.safety_voice_be.global.exception.code;
...
public enum ErrorCode implements BaseErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "401_003", "비밀번호가 올바르지 않습니다."),
    ...
    USER_SETTING_NOT_FOUND(HttpStatus.NOT_FOUND, "404_003", "사용자 설정을 찾을 수 없습니다."),
    ...
    DUPLICATE_LOGIN_ID(HttpStatus.CONFLICT, "409_002", "이미 존재하는 아이디입니다."),
